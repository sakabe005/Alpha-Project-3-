...
githubのdownload zip等でローカルに保存してから、
...
python公式サイトhttps://www.python.org/downloads/　からpython3をダウンロード、
...
visual studio code 公式サイトhttps://code.visualstudio.com/download　からインストーラをダウンロードした後、exeファイルを実行し、インストーラを立ち上げます。
